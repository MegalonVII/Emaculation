...
url=$(curl -s https://api.github.com/repos/cemu-project/Cemu/releases/latest \
...
output_file="$DEST_DIR/Cemu-macos-latest.dmg"
echo
echo "Downloading latest Cemu build..."
...
cp -R "/Volumes/"*/Cemu.app "$DEST_DIR/"

hdiutil detach "$volume" -quiet
rm -f "$output_file"

echo "Latest Cemu build downloaded."
echo
